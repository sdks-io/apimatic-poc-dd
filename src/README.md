...
Visit the [Published Portal](https://admin.apimatic-poc-dd.pages.dev/).
...
[click here](https://admin.apimatic-poc-dd.pages.dev/#/net-standard-library/api-endpoints/pet/update-pet) to view how the multiple request examples look in the published portal.
...
[click here](https://admin.apimatic-poc-dd.pages.dev/#/net-standard-library/api-endpoints/pet/add-pet) to view how the OneOf and AnyOf Types look in the published portal.
